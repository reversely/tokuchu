...
const FIXTURE = {
  event: {
    ...
    contact: { email: "tokuchu-vendor@example.com", phone: "4165550123" }
  },
  guests: [
...
/** Hands one experiment's Tokuchu context to the personalization run with the shared event and order settings. */
...
/** One experiment's Tokuchu side: event, questions, three going guests with answers, the personalized gift, its mappings, and a vendor token. */
