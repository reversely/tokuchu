...
test("3: the organizer requests the product's fields, the responses fill the records, and the specs are approved", async () => {
  ...
  await tut("Step 3 of 5", "Request the details from attendees", "The store's fields become the requirements. The location and the date come from the event and the name from the RSVP; the size is asked with the choices the product's variants carry.", 5500);
  await caption("3. The organizer requests the size the shirt needs");
