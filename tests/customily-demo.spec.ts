 ...
 * carting a personalized star-map crewneck per guest onto the live storefront. Two Tokuchu browser
 * contexts (the organizer and a guest) record to tests/videos; the batch driver records the
 * storefront session to tests/videos as well. A caption at the foot of each Tokuchu page names the
