...
/** A search source: the Shopify catalog or the configured custom shop; a card names its sources, and a card row without them searches the catalog alone. */
export type Source = "shopify" | "customshop";
...
export type Candidate = {
  ...
  /** Set on a configured custom-shop product: the fields each unit carries. */
