 ...
 * and the change feed from Tokuchu's MCP endpoint, and posts what a vendor posts: a confirmation
 ...
 *
 * Run: npx tsx scripts/vendor-agent.mts <base url> <event id> <token id> <gift id> [confirm|ship|watch]
